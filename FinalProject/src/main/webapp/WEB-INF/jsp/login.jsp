                        ...
                        <div class="card text-white"
                            ...
                            <div class="card-body p-5 text-center" style="height: 600px;">
                                <form method="POST" role="form"
                                    ...
                                    <div class="mb-md-5 mt-md-4 pb-5">
                                        ...
                                        <div class="form-dark mb-4">
                                            ...
                                            <input type="email" id="typeEmailX" name="customerEmail"
                                        ...
                                        <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="forgotPasswordForm.htm">Forgot
                                            password?</a>
                                        </p>
                                ...
                                <div style="margin-top: -85px">
                                    <p class="mb-0">Don't have an account? <a href="signup.htm"
                                                                              class="text-white-50 fw-bold">Create an
                                        Account</a></p>
                                </div>
