...
<nav class="navbar navbar-expand-lg navbar-dark text-center"
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav" style="font-size: 20px;">
            ...
            <li class="nav-item dropdown">
                <a type="button" class="nav-link dropdown-toggle active disabled" data-bs-toggle="dropdown"
                   aria-expanded="false">Customers</a>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li><a class="dropdown-item" href="#">View/Delete Customer</a></li>
                </ul>
            </li>
            <li class="nav-item">
            ...
            <%
                ...
                if(admin == null ){
                    String site = "http://localhost:8080/WebToolsProject_war_exploded/index.htm";
...
<div class="jumbotron jumbotron-fluid"
    ...
    <div class="container text-white" style="background-color: rgb(21,21,21)">
        <h1 class="display-4 justify-content-center">Your Customers</h1>
    </div>
</div>
...
<div class="container px-3 my-5 clearfix">
    ...
    <%
        if(session.getAttribute("error") != null){
            ...
            if(error){
                out.println("<p class=\"text-center text-danger\">Trying to delete already deleted Customer or Customer is not present.</p>");
            }
        }
    %>
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered m-0" id="vinit">
                    ...
                    <tr>
                        <!-- Set columns width -->
                        <th class="text-center py-3 px-4" style="min-width: 400px;">Customer #</th>
                        <th class="text-center py-3 px-4" style="width: 100px;">Email</th>
                        <th class="text-center py-3 px-4" style="width: 100px;">Created On</th>
                        <th class="text-center py-3 px-4" style="width: 100px;">Orders Placed</th>
                    ...
                    <%
                        ...
                        for (Customer u : customerList) {
                            int orders = u.getCustomerOrders().size();
                            out.println("<tr>");
                            out.println("<td class=\"text-center font-weight-semibold align-middle p-4 w-25\">"+u.getCustomerId()+"</td>");
                            out.println("<td class=\"text-center font-weight-semibold align-middle p-4\">" + u.getCustomerEmail() + "</td>");
                            out.println("<td class=\"text-center font-weight-semibold align-middle p-4 w-25\">" + u.getCustomerRegDate() + "</td>");
                            out.println("<td class=\"text-center font-weight-semibold align-middle p-4\" >" + orders + "</td>");
                            out.println("<td class=\"text-center align-middle px-0\"><a href=\"removeCustomerAdmin.htm?customerId=" + u.getCustomerId() + "\" class=\"shop-tooltip close float-none text-danger\" title=\"\" data-original-title=\"Remove\">×</a></td>");
                            out.println("</tr>");
                        }
                    %>
                    </tbody>
